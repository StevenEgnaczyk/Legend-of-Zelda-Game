...
public class Item2State : IItemState
{
    private Item item;
    ...
    {
        Texture2D item2 = Texture2DStorage.GetItem2Sprite();
        Rectangle sourceRect = itemSprites[currentIndex];
        item.DrawSprite(spriteBatch, item2, sourceRect);
